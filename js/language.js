const json_langauge = {
    italiano: [
        ...
        { "id": "Frontend-skills__subtitile-txt", "html": "Più di " + calcYear(new Date("1/1/2017") )  + " anni" },
        { "id": "Backend-skills__subtitile-txt", "html": "Più di " + calcYear(new Date("1/1/2018") )  + " anni" },
        { "id": "AI-skills__subtitile-txt", "html": "Solo " + calcYear(new Date("9/15/2020") ) + " anno" },
        { "id": "BI-skills__subtitile-txt", "html": "Solo " + calcYear(new Date("9/15/2020") ) + " anno" },
    ...
    english: [
        ...
        { "id": "Frontend-skills__subtitile-txt", "html": "More than " + calcYear(new Date("1/1/2017") ) + " years" },
        { "id": "Backend-skills__subtitile-txt", "html": "More than " + calcYear(new Date("1/1/2018") ) + " years" },
        { "id": "AI-skills__subtitile-txt", "html": "Only " + calcYear(new Date("9/15/2020") ) + " year" },
        { "id": "BI-skills__subtitile-txt", "html": "Only " + calcYear(new Date("9/15/2020") ) + " year" },
