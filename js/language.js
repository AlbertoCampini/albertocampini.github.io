const json_langauge = {
    italiano: [
        ...
        { 'id': "home-description-txt", "html": "Sono Alberto Campini ho " + calcolaAnniPassati(new Date("8/23/1999") )+" anni, laureato in informatica, data analyst presso <b>Reply</b>, Fouder di <b>ABC Labs</b>" },
        ...
        { 'id': "AI-skills__subtitle-txt", "html": "Più di " + calcolaAnniPassati(new Date("9/15/2021") ) + " anni" },
        { 'id': "BI-skills__subtitle-txt", "html": "Più di " + calcolaAnniPassati(new Date("9/15/2021") ) + " anni" },
        { 'id': "SW-skills__subtitle-txt", "html": "Più di " + calcolaAnniPassati(new Date("9/15/2021") ) + " anni" },
        ...
        { 'id': "qualification-education-link-master-thesis-txt", "html": "Leggi la Tesi 🇮🇹" },
    ...
    english: [
        ...
        { 'id': "home-description-txt", "html": "My name is Alberto Campini, I have "+ calcolaAnniPassati(new Date("8/23/1999") ) +" years, graduated in computer science, Data Analyst at <b>Reply</b>, Fouder of <b>ABC Labs</b>" },
        ...
        { 'id': "AI-skills__subtitle-txt", "html": "More than " + calcolaAnniPassati(new Date("9/15/2021") ) + " years" },
        { 'id': "BI-skills__subtitle-txt", "html": "More than " + calcolaAnniPassati(new Date("9/15/2021") ) + " years" },
        { 'id': "SW-skills__subtitle-txt", "html": "More than " + calcolaAnniPassati(new Date("9/15/2021") ) + " years" },
        ...
        { 'id': "qualification-education-link-master-thesis-txt", "html": "Read my thesis 🇮🇹" },
        { 'id': "footer-copy", "html": "&#169; ABC Labs, All rigth reserved" },
        { 'id': "footer-link-portfolio-txt", "html": "Portfolio" },
